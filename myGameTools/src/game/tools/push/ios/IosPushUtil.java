...
//        pushPayloadDevicePairs(devices, "Hello 111111111", 1, null, null);
     ...
     * @throws KeystoreException
     */
    public static void pushPayload(List<Device> devices, String msg,Integer badge,String sound,Map<String,String> map) throws Exception, CommunicationException, KeystoreException{
     ...
     * @throws KeystoreException
     */
    public static void pushPayloadDevicePairs(List<Device> devices,String msg,Integer badge,String sound,Map<String,String> map) throws Exception, CommunicationException, KeystoreException{
    ...
    public static void queue(String [] deviceTokens,String msg,Integer badge,String sound,Map<String,String> map) throws KeystoreException, Exception
    {
     ...
     * @throws JSONException
     */
    public static void queue(List<Device> devices,String msg,Integer badge,String sound,Map<String,String> map) throws KeystoreException, Exception{
        PushQueue queue = Push.queue(keystore, password, production, numberOfThreads);
        queue.start();
        PayloadPerDevice perDevice = null;
        for (int i = 0; i <devices.size(); i++) {
     ...
     * @throws JSONException
     */
    private static PushNotificationPayload customPayload(String msg,Integer badge,String sound,Map<String,String> map) throws Exception{
