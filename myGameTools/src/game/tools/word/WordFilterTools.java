...
public class WordFilterTools 
{
	private static final WordFilter FILTER = new WordFilter("conf/bad_word.txt");
...
//		System.out.println(wordFilter.filter(string));;
		for (int i = 0; i < 100; i++) {
			System.out.println(WordFilterTools.filter(string));
		}
	...
	public static final boolean has(String text)
	{
